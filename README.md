...
#Database Creation
#Connect your MySQL and Python before running the code
import mysql.connector as msq
import tqdm
import time
con=msq.connect(host='localhost',user='root',passwd='student',database='') #Change the password to your password
cur=con.cursor()
if con.is_connected():
                        ...
                        P_Age int(3),\
                            P_Gender varchar(10),\
                                P_Address varchar(100),\
                                    P_PhNo varchar(15));")
    for i in tqdm.tqdm(range(50)): #Did this just for fun
        time.sleep(0.001)
...
#Sorry for all the meaningless variables
#Hospital Management
print("*****************************************************************") #I don't know how to use tkinter so did this instead
print("*                                                               *") #This looks so good if run in an external terminal lol
...
while x==0: 
    ...
    if choice=='1':
        ...
        print("*****************************************")
        x=1 #All these Xs' in the code helps to go back to the while loop with the valueof X which I need 
        passwd=input("Enter the password : ")
        if passwd=='': #No password created so just click enter or create your own
            while x==1:
                print("-------------------------------------")
                    ...
                    while x==2:
                        ...
                        if choice=='1':
                            ...
                            if n==0:
                                ...
                                x=rs[n-1][0] #This part helps to create a Patient id automatically
                                a=int(x[1:])
                                P_ID='P'+str(a+1)
